...
export default class CustomTimeSelecter extends React.Component {
    constructor() {
        super();
    ...
    scrollFix(e) {
        ...
        this?.props?.getTime(selectedValue)
    }
...
CustomTimeSelecter.defaultProps = {
    dataSource: [1, 2, 3],
    itemHeight: 80,
    wrapperBackground: '#FFFFFF',
    wrapperHeight: RFPercentage(30),
    ...
    itemTextStyle: { fontSize: RFPercentage(2.5), lineHeight: RFPercentage(3), textAlign: 'center', color: '#B4B4B4' },
    activeItemTextStyle: {
        textAlign: 'center', color: Colors.white, fontSize: RFPercentage(3),
        // fontFamily: Platform.OS == 'ios' ? 'Comfortaa-Regular' : 'Comfortaa-VariableFont_wght',
    }
};