...
export const styles = StyleSheet.create({
    ...
    middleContainer: { flexDirection: 'row', flex: 1, justifyContent: 'space-between' },
    gatherContainer: (index) => ({ height: 100, width: '100%', paddingVertical: RFPercentage(1.5), overflow: "hidden", borderTopWidth: index == 0 ? 0 : .5, borderTopColor: Colors.tabInactive, }),
