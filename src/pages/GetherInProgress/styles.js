...
export const styles = StyleSheet.create({
    ...
    hoursContainer: { flex: 1, alignItems: 'center', borderRadius: RFPercentage(1) },

    BookingTagsText: { flex: 1, fontSize: RFPercentage(2), textAlign: 'center', textTransform: 'capitalize' },
