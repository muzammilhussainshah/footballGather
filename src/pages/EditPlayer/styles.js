...
export const styles = StyleSheet.create({
    ...
    skillSetModalContainer: { height: "90%", width: "100%", justifyContent: "flex-start", alignItems: 'flex-start', backgroundColor: Colors.tabBg, borderRadius: RFPercentage(1), },
    ...
    skillSetModalListContainer: (isModalVisible, flex1) => ({ backgroundColor: '#3f3f3f', marginTop: RFPercentage(2), paddingLeft: RFPercentage(1), height: isModalVisible == 'skill' ? flex1 * 2 : flex1 * 3, width: '100%' }),
